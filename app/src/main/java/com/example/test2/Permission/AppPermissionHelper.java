package com.example.test2.Permission;
...
public class AppPermissionHelper {
    ...
    public static final boolean useHandlerActivity = true;
    ...
    public void checkAndRequestPermission(Activity activity, String permission, AppPermissionCallbackHandler handler){
        checkAndRequestPermissions(activity, new String [] {permission}, handler);
    }

    public void checkAndRequestPermissions(Activity activity, String[] permissions, AppPermissionCallbackHandler handler){
